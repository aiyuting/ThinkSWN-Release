 ...
 * 功能:查询标签列表,支持分页;
 */
function sp_tags($tag,$where=array(),$pagesize=0,$pagetpl=''){
    return ApiService::tags($tag,$where,$pagesize,$pagetpl);
}
 ...
 */
function sp_sql_posts_paged_bytagid($tag_id,$tag,$pagesize=20,$pagetpl=''){
	return ApiService::postsPagedByTagId($tag_id,$tag,$pagesize,$pagetpl);
}
/**
 * 获取指定id的文章
