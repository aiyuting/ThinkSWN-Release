...
CREATE TABLE IF NOT EXISTS `swn_ad` (
...
CREATE TABLE IF NOT EXISTS `swn_answers` (
  `id` bigint(20) NOT NULL,
  `qid` bigint(20) NOT NULL COMMENT '问题ID',
  `uid` bigint(20) NOT NULL COMMENT '回答者ID',
  `ctn` text NOT NULL COMMENT '回答内容',
  `likes` int(11) NOT NULL DEFAULT '0' COMMENT '点赞数',
  `unlikes` int(11) NOT NULL DEFAULT '0' COMMENT '点踩数',
  `isbest` int(1) NOT NULL DEFAULT '0' COMMENT '是否最佳答案',
  `create_date` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '回答时间'
...
CREATE TABLE IF NOT EXISTS `swn_asset` (
...
--
-- 表的结构 `swn_auth_access`
--

CREATE TABLE IF NOT EXISTS `swn_auth_access` (
...
CREATE TABLE IF NOT EXISTS `swn_auth_rule` (
...
--
-- 转存表中的数据 `swn_auth_rule`
--

INSERT INTO `swn_auth_rule` (`id`, `module`, `type`, `name`, `param`, `title`, `status`, `condition`) VALUES
...
(7, 'Portal', 'admin_url', 'portal/adminpost/article_index', NULL, '文章管理', 1, ''),
...
(174, 'Portal', 'admin_url', 'portal/adminpost/question_index', NULL, '问题管理', 1, ''),
(175, 'Portal', 'admin_url', 'portal/adminpost/question_add', NULL, '添加问题', 1, ''),
(176, 'Portal', 'admin_url', 'portal/adminpost/question_edit', NULL, '编辑问题', 1, ''),
(177, 'Admin', 'admin_url', 'admin/spider/index', NULL, '蜘蛛记录', 1, ''),
(178, 'Portal', 'admin_url', 'portal/adminpost/answer_index', NULL, '答案管理', 1, '');
...
CREATE TABLE IF NOT EXISTS `swn_comments` (
...
--
-- 表的结构 `swn_common_action_log`
--

CREATE TABLE IF NOT EXISTS `swn_common_action_log` (
  `id` int(11) NOT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=73 DEFAULT CHARSET=utf8 COMMENT='访问记录表';
...
CREATE TABLE IF NOT EXISTS `swn_guestbook` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `swn_links` (
...
CREATE TABLE IF NOT EXISTS `swn_menu` (
...
INSERT INTO `swn_menu` (`id`, `parentid`, `app`, `model`, `action`, `data`, `type`, `status`, `name`, `icon`, `remark`, `listorder`) VALUES
...
(4, 1, 'Comment', 'Commentadmin', 'index', '', 1, 1, '评论管理', '', '', 4),
(5, 4, 'Comment', 'Commentadmin', 'delete', '', 1, 0, '删除评论', '', '', 0),
(6, 4, 'Comment', 'Commentadmin', 'check', '', 1, 0, '评论审核', '', '', 0),
(7, 1, 'Portal', 'AdminPost', 'article_index', '', 1, 1, '文章管理', '', '', 1),
...
(18, 1, 'Portal', 'AdminTerm', 'index', '', 0, 1, '分类管理', '', '', 6),
...
(25, 1, 'Portal', 'AdminPage', 'index', '', 1, 1, '页面管理', '', '', 7),
...
(32, 1, 'Admin', 'Recycle', 'default', '', 1, 1, '回收站', '', '', 8),
...
(187, 1, 'Portal', 'AdminPost', 'question_index', '', 1, 1, '问题管理', '', '', 2),
(188, 187, 'Portal', 'AdminPost', 'question_add', '', 1, 0, '添加问题', '', '', 0),
(189, 187, 'Portal', 'AdminPost', 'question_edit', '', 1, 0, '编辑问题', '', '', 0),
(190, 39, 'Admin', 'Spider', 'index', '', 0, 1, '蜘蛛记录', '', '', 0),
(191, 1, 'Portal', 'AdminPost', 'answer_index', '', 1, 1, '答案管理', '', '', 3);
...
CREATE TABLE IF NOT EXISTS `swn_nav` (
  `id` int(11) NOT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='前台导航表';

--
-- 转存表中的数据 `swn_nav`
--

INSERT INTO `swn_nav` (`id`, `cid`, `parentid`, `label`, `target`, `href`, `icon`, `status`, `listorder`, `path`) VALUES
(1, 1, 0, '首页', '', 'home', '', 1, 1, '0-1'),
(9, 1, 0, '问题', '', 'a:2:{s:6:"action";s:22:"Portal/Questions/index";s:5:"param";a:0:{}}', '', 1, 3, '0-9'),
(10, 1, 0, '话题', '', 'a:2:{s:6:"action";s:15:"Portal/Tags/hot";s:5:"param";a:0:{}}', '', 1, 4, '0-10'),
(8, 1, 0, '文章', '', 'a:2:{s:6:"action";s:21:"Portal/Articles/index";s:5:"param";a:0:{}}', '', 1, 2, '0-8');
...
CREATE TABLE IF NOT EXISTS `swn_nav_cat` (
...
INSERT INTO `swn_nav_cat` (`navcid`, `name`, `active`, `remark`) VALUES
(1, '主导航', 1, '主导航');
...
CREATE TABLE IF NOT EXISTS `swn_oauth_user` (
  `id` int(20) NOT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='第三方用户表';
...
CREATE TABLE IF NOT EXISTS `swn_options` (
...
INSERT INTO `swn_options` (`option_id`, `option_name`, `option_value`, `autoload`) VALUES
(1, 'member_email_active', '{"title":"ThinkSWN\u90ae\u4ef6\u6fc0\u6d3b\u901a\u77e5.","template":"<p>\u672c\u90ae\u4ef6\u6765\u81ea<a href=\"http:\/\/www.thinkswn.com\">ThinkSWN<\/a><br\/><br\/>&nbsp; &nbsp;<strong>---------------<strong style=\"white-space: normal;\">---<\/strong><\/strong><br\/>&nbsp; &nbsp;<strong>\u5e10\u53f7\u6fc0\u6d3b\u8bf4\u660e<\/strong><br\/>&nbsp; &nbsp;<strong>---------------<strong style=\"white-space: normal;\">---<\/strong><\/strong><br\/><br\/>&nbsp; &nbsp; \u5c0a\u656c\u7684<span style=\"FONT-SIZE: 16px; FONT-FAMILY: Arial; COLOR: rgb(51,51,51); LINE-HEIGHT: 18px; BACKGROUND-COLOR: rgb(255,255,255)\">#username#\uff0c\u60a8\u597d\u3002<\/span>\u5982\u679c\u60a8\u662fThinkSWN\u7684\u65b0\u7528\u6237\uff0c\u6216\u5728\u4fee\u6539\u60a8\u7684\u6ce8\u518cEmail\u65f6\u4f7f\u7528\u4e86\u672c\u5730\u5740\uff0c\u6211\u4eec\u9700\u8981\u5bf9\u60a8\u7684\u5730\u5740\u6709\u6548\u6027\u8fdb\u884c\u9a8c\u8bc1\u4ee5\u907f\u514d\u5783\u573e\u90ae\u4ef6\u6216\u5730\u5740\u88ab\u6ee5\u7528\u3002<br\/>&nbsp; &nbsp; \u60a8\u53ea\u9700\u70b9\u51fb\u4e0b\u9762\u7684\u94fe\u63a5\u5373\u53ef\u6fc0\u6d3b\u60a8\u7684\u5e10\u53f7\uff1a<br\/>&nbsp; &nbsp; <a title=\"\" href=\"http:\/\/#link#\" target=\"_self\">http:\/\/#link#<\/a><br\/>&nbsp; &nbsp; (\u5982\u679c\u4e0a\u9762\u4e0d\u662f\u94fe\u63a5\u5f62\u5f0f\uff0c\u8bf7\u5c06\u8be5\u5730\u5740\u624b\u5de5\u7c98\u8d34\u5230\u6d4f\u89c8\u5668\u5730\u5740\u680f\u518d\u8bbf\u95ee)<br\/>&nbsp; &nbsp; \u611f\u8c22\u60a8\u7684\u8bbf\u95ee\uff0c\u795d\u60a8\u4f7f\u7528\u6109\u5feb\uff01<br\/><br\/>&nbsp; &nbsp; \u6b64\u81f4<br\/>&nbsp; &nbsp; ThinkSWN \u7ba1\u7406\u56e2\u961f.<\/p>"}', 1);
-- --------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `swn_plugins` (
...
INSERT INTO `swn_plugins` (`id`, `name`, `title`, `description`, `type`, `status`, `config`, `hooks`, `has_admin`, `author`, `version`, `createtime`, `listorder`) VALUES
(1, 'Comment', '评论插件', '评论插件', 0, 1, '', 'comment', 0, 'ThinkSWN', '1.0', 0, 0);
...
CREATE TABLE IF NOT EXISTS `swn_posts` (
  `id` bigint(20) unsigned NOT NULL,
  ...
  `type` varchar(10) NOT NULL DEFAULT 'article' COMMENT '类型',
  `reward` int(11) NOT NULL DEFAULT '0' COMMENT '悬赏金',
  `best` bigint(20) DEFAULT NULL COMMENT '最佳答案',
  `to_user` bigint(20) DEFAULT NULL COMMENT '邀请回答者ID',
  `form_id` varchar(32) DEFAULT NULL COMMENT '微信小程序form_id',
  `tags_id` text COMMENT '标签ID'
) ENGINE=MyISAM AUTO_INCREMENT=201 DEFAULT CHARSET=utf8 COMMENT='Portal文章表';
...
CREATE TABLE IF NOT EXISTS `swn_role` (
...
INSERT INTO `swn_role` (`id`, `name`, `pid`, `status`, `remark`, `create_time`, `update_time`, `listorder`) VALUES
...
CREATE TABLE IF NOT EXISTS `swn_role_user` (
...
CREATE TABLE IF NOT EXISTS `swn_route` (
  `id` int(11) NOT NULL COMMENT '路由id',
  `full_url` varchar(255) DEFAULT NULL COMMENT '完整url， 如：portal/list/index?id=1',
  `url` varchar(255) DEFAULT NULL COMMENT '实际显示的url',
  `listorder` int(5) DEFAULT '0' COMMENT '排序，优先级，越小优先级越高',
  `status` tinyint(1) DEFAULT '1' COMMENT '状态，1：启用 ;0：不启用'
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='url路由表';

--
-- 转存表中的数据 `swn_route`
--

INSERT INTO `swn_route` (`id`, `full_url`, `url`, `listorder`, `status`) VALUES
(2, 'portal/article/index', 'article/:id\\d', 0, 1),
(4, 'portal/question/index', 'question/:id\\d', 0, 1),
(5, 'portal/articles/index', 'articles/p/:p\\d', 0, 1),
(6, 'portal/questions/index', 'questions', 0, 1),
(7, 'portal/list/index', 'list/:id\\d', 0, 1),
(11, 'portal/questions/index', 'questions/p/:p\\d', 0, 1),
(10, 'portal/articles/index', 'articles', 0, 1),
(12, 'portal/tags/index', 'tags/:id\\d', 0, 1);
...
CREATE TABLE IF NOT EXISTS `swn_slide` (
...
CREATE TABLE IF NOT EXISTS `swn_slide_cat` (
  `cid` int(11) NOT NULL,
...
--
-- 转存表中的数据 `swn_slide_cat`
--

INSERT INTO `swn_slide_cat` (`cid`, `cat_name`, `cat_idname`, `cat_remark`, `cat_status`) VALUES
(1, '首页-最新推荐', 'portal_index', '', 1);
...
CREATE TABLE IF NOT EXISTS `swn_spiders` (
  ...
  `url` varchar(50) NOT NULL COMMENT '受访URL',
  `referer` varchar(50) DEFAULT NULL COMMENT '来源URL',
  `dateline` datetime NOT NULL DEFAULT '2000-01-01 00:00:00'
) ENGINE=InnoDB AUTO_INCREMENT=4766 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `swn_tags` (
  `id` bigint(20) NOT NULL,
  `name` varchar(20) NOT NULL COMMENT '标签名称',
  `post_id` text NOT NULL COMMENT '文章/问题ID',
  `dateline` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '创建时间',
...
CREATE TABLE IF NOT EXISTS `swn_terms` (
...
INSERT INTO `swn_terms` (`term_id`, `name`, `slug`, `taxonomy`, `description`, `parent`, `count`, `path`, `seo_title`, `seo_keywords`, `seo_description`, `list_tpl`, `one_tpl`, `listorder`, `status`) VALUES
(5, 'BUG反馈', '', 'article', '', 0, 0, '0-5', '', '', '', 'list', 'article', 2, 1),
(6, '技术交流', '', 'article', '', 0, 0, '0-6', '', '', '', 'list', 'article', 1, 1),
(7, '功能建议', '', 'article', '', 0, 0, '0-7', '', '', '', 'list', 'article', 3, 1);

-- --------------------------------------------------------

--
-- 表的结构 `swn_term_relationships`
--

CREATE TABLE IF NOT EXISTS `swn_term_relationships` (
  `tid` bigint(20) NOT NULL,
  `object_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT 'posts表里文章id',
  `term_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '分类id',
  `listorder` int(10) NOT NULL DEFAULT '0' COMMENT '排序',
  `status` int(2) NOT NULL DEFAULT '1' COMMENT '状态，1发布，0不发布'
) ENGINE=MyISAM AUTO_INCREMENT=183 DEFAULT CHARSET=utf8 COMMENT='Portal 文章分类对应表';
...
CREATE TABLE IF NOT EXISTS `swn_users` (
  `id` bigint(20) unsigned NOT NULL,
  ...
  `expert` int(1) NOT NULL DEFAULT '0' COMMENT '是否专家',
...
--
-- 表的结构 `swn_user_favorites`
--

CREATE TABLE IF NOT EXISTS `swn_user_favorites` (
  `id` int(11) NOT NULL,
...
--
-- 表的结构 `wei_access_token`
--

CREATE TABLE IF NOT EXISTS `wei_access_token` (
  `id` int(5) NOT NULL,
  `access_token` text NOT NULL,
  `access_token_update_time` int(11) NOT NULL,
  `access_token_expires_in` int(5) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='微信小程序设置';
...
CREATE TABLE IF NOT EXISTS `wei_user` (
  `id` int(11) NOT NULL,
  `openid` varchar(32) NOT NULL COMMENT '用户唯一标识',
  `unionid` varchar(32) DEFAULT NULL COMMENT '跨公众平台用户唯一标识',
  ...
  `expires_in` int(8) NOT NULL COMMENT '会话有效期, 以秒为单位, 例如2592000代表会话有效期为30天',
  `dateline` int(11) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=2248 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='微信小程序用户表';
...
--
-- Indexes for table `swn_answers`
--
ALTER TABLE `swn_answers`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `swn_asset`
--
ALTER TABLE `swn_asset`
  ADD PRIMARY KEY (`aid`);

--
-- Indexes for table `swn_auth_access`
--
ALTER TABLE `swn_auth_access`
  ADD KEY `role_id` (`role_id`),
  ADD KEY `rule_name` (`rule_name`) USING BTREE;

--
-- Indexes for table `swn_auth_rule`
--
ALTER TABLE `swn_auth_rule`
  ADD PRIMARY KEY (`id`),
  ADD KEY `module` (`module`,`status`,`type`);

--
-- Indexes for table `swn_comments`
--
ALTER TABLE `swn_comments`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `swn_common_action_log`
--
ALTER TABLE `swn_common_action_log`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_object_action` (`user`,`object`,`action`),
  ADD KEY `user_object_action_ip` (`user`,`object`,`action`,`ip`);

--
-- Indexes for table `swn_guestbook`
--
ALTER TABLE `swn_guestbook`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `swn_links`
--
ALTER TABLE `swn_links`
  ADD PRIMARY KEY (`link_id`),
  ADD KEY `link_visible` (`link_status`);

--
-- Indexes for table `swn_menu`
--
ALTER TABLE `swn_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `swn_nav`
--
ALTER TABLE `swn_nav`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `swn_nav_cat`
--
ALTER TABLE `swn_nav_cat`
  ADD PRIMARY KEY (`navcid`);

--
-- Indexes for table `swn_oauth_user`
--
ALTER TABLE `swn_oauth_user`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `swn_options`
--
ALTER TABLE `swn_options`
  ADD PRIMARY KEY (`option_id`),
  ADD UNIQUE KEY `option_name` (`option_name`);

--
-- Indexes for table `swn_plugins`
--
ALTER TABLE `swn_plugins`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `swn_posts`
--
ALTER TABLE `swn_posts`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `swn_role`
--
ALTER TABLE `swn_role`
  ADD PRIMARY KEY (`id`),
  ADD KEY `parentId` (`pid`),
  ADD KEY `status` (`status`);

--
-- Indexes for table `swn_role_user`
--
ALTER TABLE `swn_role_user`
  ADD KEY `group_id` (`role_id`),
  ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `swn_route`
--
ALTER TABLE `swn_route`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `swn_slide`
--
ALTER TABLE `swn_slide`
  ADD PRIMARY KEY (`slide_id`),
  ADD KEY `slide_cid` (`slide_cid`);

--
-- Indexes for table `swn_slide_cat`
--
ALTER TABLE `swn_slide_cat`
  ADD PRIMARY KEY (`cid`),
  ADD KEY `cat_idname` (`cat_idname`);

--
-- Indexes for table `swn_spiders`
--
ALTER TABLE `swn_spiders`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Indexes for table `swn_tags`
--
ALTER TABLE `swn_tags`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);

--
-- Indexes for table `swn_terms`
--
ALTER TABLE `swn_terms`
  ADD PRIMARY KEY (`term_id`);

--
-- Indexes for table `swn_term_relationships`
--
ALTER TABLE `swn_term_relationships`
  ADD PRIMARY KEY (`tid`),
  ADD KEY `term_taxonomy_id` (`term_id`);

--
-- Indexes for table `swn_users`
--
ALTER TABLE `swn_users`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_login_key` (`user_login`),
  ADD KEY `user_nicename` (`user_nicename`);

--
-- Indexes for table `swn_user_favorites`
--
ALTER TABLE `swn_user_favorites`
  ADD PRIMARY KEY (`id`),
  ADD KEY `uid` (`uid`);

--
-- Indexes for table `wei_access_token`
--
ALTER TABLE `wei_access_token`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `wei_user`
--
ALTER TABLE `wei_user`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `swn_ad`
--
ALTER TABLE `swn_ad`
  MODIFY `ad_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '广告id',AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `swn_answers`
--
ALTER TABLE `swn_answers`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=60;
--
-- AUTO_INCREMENT for table `swn_asset`
--
ALTER TABLE `swn_asset`
  MODIFY `aid` bigint(20) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `swn_auth_rule`
--
ALTER TABLE `swn_auth_rule`
  MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT '规则id,自增主键',AUTO_INCREMENT=179;
--
-- AUTO_INCREMENT for table `swn_comments`
--
ALTER TABLE `swn_comments`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=28;
--
-- AUTO_INCREMENT for table `swn_common_action_log`
--
ALTER TABLE `swn_common_action_log`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=73;
--
-- AUTO_INCREMENT for table `swn_guestbook`
--
ALTER TABLE `swn_guestbook`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `swn_links`
--
ALTER TABLE `swn_links`
  MODIFY `link_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `swn_menu`
--
ALTER TABLE `swn_menu`
  MODIFY `id` smallint(6) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=192;
--
-- AUTO_INCREMENT for table `swn_nav`
--
ALTER TABLE `swn_nav`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `swn_nav_cat`
--
ALTER TABLE `swn_nav_cat`
  MODIFY `navcid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `swn_oauth_user`
--
ALTER TABLE `swn_oauth_user`
  MODIFY `id` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT for table `swn_options`
--
ALTER TABLE `swn_options`
  MODIFY `option_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `swn_plugins`
--
ALTER TABLE `swn_plugins`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增id',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `swn_posts`
--
ALTER TABLE `swn_posts`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=201;
--
-- AUTO_INCREMENT for table `swn_role`
--
ALTER TABLE `swn_role`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `swn_route`
--
ALTER TABLE `swn_route`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '路由id',AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `swn_slide`
--
ALTER TABLE `swn_slide`
  MODIFY `slide_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `swn_slide_cat`
--
ALTER TABLE `swn_slide_cat`
  MODIFY `cid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `swn_spiders`
--
ALTER TABLE `swn_spiders`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4766;
--
-- AUTO_INCREMENT for table `swn_tags`
--
ALTER TABLE `swn_tags`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=78;
--
-- AUTO_INCREMENT for table `swn_terms`
--
ALTER TABLE `swn_terms`
  MODIFY `term_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类id',AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `swn_term_relationships`
--
ALTER TABLE `swn_term_relationships`
  MODIFY `tid` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=183;
--
-- AUTO_INCREMENT for table `swn_users`
--
ALTER TABLE `swn_users`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=27;
--
-- AUTO_INCREMENT for table `swn_user_favorites`
--
ALTER TABLE `swn_user_favorites`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `wei_access_token`
--
ALTER TABLE `wei_access_token`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `wei_user`
--
ALTER TABLE `wei_user`
