...
class SettingController extends AdminbaseController{
	...
	public function site(){
		...
		$this->assign("zz_settings",$zz_settings);
		
		$wxapp_settings=sp_get_option('wxapp_settings');
		$this->assign("wxapp_settings",$wxapp_settings);
	...
	public function site_post(){
		if (IS_POST) {
			...
			$zz_settings=I('post.zz_settings/a');
			sp_set_option('zz_settings', $zz_settings);
			
			$wxapp_settings=I('post.wxapp_settings/a');
			sp_set_option('wxapp_settings', $wxapp_settings);
			if ($result!==false) {
				$this->success("保存成功！");
			} else {
				$this->error("保存失败！");
